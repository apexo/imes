function (newDoc, oldDoc, userCtx, secObj) {
	...
	if (newDoc._id.charAt(0) === "_" || newDoc._id === "app" || newDoc._id.substring(0, 5) === "imes:" || newDoc._id.substring(0, 8) === "history:") {
		if (!isAdmin) {
	...
	if (type === "file" || type === "picture" || type === "imes:state" || type === "imes:channel" || type === "history") {
		if (!isAdmin) {
